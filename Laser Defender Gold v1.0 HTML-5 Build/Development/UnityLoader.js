...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Laser Defender Gold v1.0 HTML-5 Build.data';
    var REMOTE_PACKAGE_BASE = 'Laser Defender Gold v1.0 HTML-5 Build.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 10788099;
      var PACKAGE_UUID = 'a45dee37-f360-49cb-a9b7-0ca848fbcf09';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 21148, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(21148, 33572, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(33572, 52520, 0, 0).open('GET', '/level0');
    new DataRequest(52520, 70516, 0, 0).open('GET', '/level1');
    new DataRequest(70516, 76884, 0, 0).open('GET', '/level2');
    new DataRequest(76884, 107504, 0, 0).open('GET', '/level3');
    new DataRequest(107504, 107871, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(107871, 111544, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(111544, 1079520, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(1079520, 7299562, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(7299562, 7312298, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(7312298, 7321158, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(7321158, 7379390, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(7379390, 9202374, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(9202374, 10699746, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(10699746, 10760474, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(10760474, 10788099, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Laser Defender Gold v1.0 HTML-5 Build.data');

    };
    Module['addRunDependency']('datafile_Laser Defender Gold v1.0 HTML-5 Build.data');
